...
const restaurants = [
  {
    info: {
      ...
      name: "Subway",
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/8/2/1776fa6d-0969-4a43-a0d3-378ca449cede_822315.jpg",
      ...
      availability: {
        nextCloseTime: "2024-09-14 01:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-09-14 02:59:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-09-14 02:45:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      id: "132622",
      name: "Marwadi chaat & Tiffin services shantinagar (Jodhpur wala)",
      cloudinaryImageId: "e8f48a82caf1cdc428448f64dba7b61e",
      locality: "Shanti Nagar",
      areaName: "Jayanagar",
      costForTwo: "₹300 for two",
      cuisines: ["Rajasthani", "Snacks", "Chaat"],
      avgRating: 4.1,
      parentId: "537301",
      avgRatingString: "4.1",
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/city/bangalore/marwadi-chaat-and-tiffin-services-shantinagar-jodhpur-wala-shanti-nagar-jayanagar-rest132622",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
  },
  {
    info: {
      ...
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/6/6/b8cac488-cbee-43b4-966c-56dffbf9e484_902512.jpg",
      locality: "National High School Road",
      areaName: "Basavanagudi",
      costForTwo: "₹300 for two",
      cuisines: ["Chaat"],
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-09-13 21:45:00",
        opened: true,
      },
      badges: {
        imageBadges: [
    ...
    <div className="body">
      ...
      <div className="res-container">
        {restaurants.map((restaurant) => (
          <RestaurantCard resData={restaurant.info} key={restaurant.info.id} link={restaurant.cta.link}/>
        ))}
      </div>
    </div>
  );
